...
import { Loader2, ShieldAlert, CheckCircle2, XCircle, Clock3, Filter } from "lucide-react";
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className="rounded-full border border-border bg-muted/50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
                        {a.patient_type} · {a.consultation_type === "primera_vez" ? "1ra vez" : "seguimiento"}
                      </span>
                    </div>
                    <div className="mt-1 text-xs text-muted-foreground">
                      DNI {a.dni} · {a.age} años · {a.phone}{a.email && ` · ${a.email}`}
                    </div>
